...
description: ".
    ...
    [subs="quotes"]"
status: new
tags: [linux-training-hogent, ssh]
...
Hostname : xen1.xen.local Distribution : buster Mirror :
 Partitions : swap 512Mb (swap) / 8gb
...
root@MBDebian\#\ **ls\ /home/xen/domains/**\ xen1.xen.local\ root@MBDebian\#

    And this image can be quickly verified with *xen-list-images*.

    [subs="quotes"]

root@MBDebian\#\ **xen-list-images**\ Name:\ xen1.xen.local\ Memory:\ 512\ MB\ IP:\ 192.168.1.101\ Config:\ /etc/xen/xen1.xen.local.cfg\ root@MBDebian\#
